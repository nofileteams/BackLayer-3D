...
(async function (Scratch) {
  ...
  class BackLayer3D {
    getInfo() {
      ...
      const onoff = {acceptReporters:true, items:[{text:"開啟",value:"on"},{text:"關閉",value:"off"}]};
      return {id:"backlayer3d", name:"後方圖層 3D", color1:"#5B5FEF", color2:"#4549C4", blocks:[
        {opcode:"reset", blockType:BlockType.COMMAND, text:"全部重設"},
        {opcode:"create", blockType:BlockType.COMMAND, text:"建立物件 [NAME]", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"textureCostume", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的材質設為服裝 [COSTUME]", arguments:{NAME:{type:S,defaultValue:"box"},COSTUME:{type:S,defaultValue:"costume1"}}},
        {opcode:"textureURL", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的材質從 URL [URL] 載入", arguments:{NAME:{type:S,defaultValue:"box"},URL:{type:S,defaultValue:"https://example.com/test.png"}}},
        {opcode:"modelOBJList", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 OBJ 模型設定為清單 [LIST]", arguments:{NAME:{type:S,defaultValue:"box"},LIST:{type:S,defaultValue:"list1"}}},
        {opcode:"modelGLTFList", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 (gltf/glb) 模型設定為清單 [LIST]", arguments:{NAME:{type:S,defaultValue:"box"},LIST:{type:S,defaultValue:"list1"}}},
        {opcode:"playAnimation", blockType:BlockType.COMMAND, text:"為物件 [NAME] 播放動畫 [ANIMATION]", arguments:{NAME:{type:S,defaultValue:"box"},ANIMATION:{type:S,defaultValue:"Animation"}}},
        {opcode:"playAnimationUntilDone", blockType:BlockType.COMMAND, text:"為物件 [NAME] 播放動畫 [ANIMATION] 並等待結束", arguments:{NAME:{type:S,defaultValue:"box"},ANIMATION:{type:S,defaultValue:"Animation"}}},
        {opcode:"remove", blockType:BlockType.COMMAND, text:"刪除物件 [NAME]", arguments:{NAME:{type:S,defaultValue:"box"}}},
        "---",
        {opcode:"setPosition", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的位置 x [X] y [Y] z [Z]", arguments:{NAME:{type:S,defaultValue:"box"},X:{type:N,defaultValue:0},Y:{type:N,defaultValue:0},Z:{type:N,defaultValue:0}}},
        {opcode:"setPositionX", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的 x 座標為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:0}}},
        {opcode:"setPositionY", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的 y 座標為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:0}}},
        {opcode:"setPositionZ", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的 z 座標為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:0}}},
        {opcode:"changePositionX", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 x 座標改變 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"changePositionY", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 y 座標改變 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"changePositionZ", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 z 座標改變 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"setRotation", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的旋轉 x [X] y [Y] z [Z]", arguments:{NAME:{type:S,defaultValue:"box"},X:{type:N,defaultValue:0},Y:{type:N,defaultValue:0},Z:{type:N,defaultValue:0}}},
        {opcode:"setRotationX", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 在 x 軸的旋轉為 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:0}}},
        {opcode:"setRotationY", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 在 y 軸的旋轉為 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:0}}},
        {opcode:"setRotationZ", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 在 z 軸的旋轉為 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:0}}},
        {opcode:"changeRotationX", blockType:BlockType.COMMAND, text:"將物件 [NAME] 繞 x 軸旋轉 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"changeRotationY", blockType:BlockType.COMMAND, text:"將物件 [NAME] 繞 y 軸旋轉 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"changeRotationZ", blockType:BlockType.COMMAND, text:"將物件 [NAME] 繞 z 軸旋轉 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"changeRotationXWorld", blockType:BlockType.COMMAND, text:"以世界座標將物件 [NAME] 繞 x 軸旋轉 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"changeRotationYWorld", blockType:BlockType.COMMAND, text:"以世界座標將物件 [NAME] 繞 y 軸旋轉 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"changeRotationZWorld", blockType:BlockType.COMMAND, text:"以世界座標將物件 [NAME] 繞 z 軸旋轉 [VALUE] 度", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"setScale", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的縮放 x [X] y [Y] z [Z]", arguments:{NAME:{type:S,defaultValue:"box"},X:{type:N,defaultValue:100},Y:{type:N,defaultValue:100},Z:{type:N,defaultValue:100}}},
        {opcode:"setScaleX", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的 x 縮放為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:100}}},
        {opcode:"setScaleY", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的 y 縮放為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:100}}},
        {opcode:"setScaleZ", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的 z 縮放為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:100}}},
        {opcode:"changeScaleX", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 x 縮放改變 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:10}}},
        {opcode:"changeScaleY", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 y 縮放改變 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:10}}},
        {opcode:"changeScaleZ", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的 z 縮放改變 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:10}}},
        {opcode:"moveSteps", blockType:BlockType.COMMAND, text:"將物件 [NAME] 移動 [STEPS] 步", arguments:{NAME:{type:S,defaultValue:"box"},STEPS:{type:N,defaultValue:10}}},
        {opcode:"moveToward", blockType:BlockType.COMMAND, text:"將物件 [NAME] 向 x [X] y [Y] z [Z] 移動 [STEPS] 步", arguments:{NAME:{type:S,defaultValue:"box"},X:{type:N,defaultValue:0},Y:{type:N,defaultValue:0},Z:{type:N,defaultValue:0},STEPS:{type:N,defaultValue:10}}},
        {opcode:"pointObject", blockType:BlockType.COMMAND, text:"讓物件 [NAME] 面向物件 [TARGET]", arguments:{NAME:{type:S,defaultValue:"box"},TARGET:{type:S,defaultValue:"target"}}},
        {opcode:"pointXYZ", blockType:BlockType.COMMAND, text:"讓物件 [NAME] 面向 x [X] y [Y] z [Z] 的位置", arguments:{NAME:{type:S,defaultValue:"box"},X:{type:N,defaultValue:0},Y:{type:N,defaultValue:0},Z:{type:N,defaultValue:0}}},
        {opcode:"glide", blockType:BlockType.COMMAND, text:"將物件 [NAME] 在 [SECONDS] 秒內滑動到 x [X] y [Y] z [Z]", arguments:{NAME:{type:S,defaultValue:"box"},SECONDS:{type:N,defaultValue:1},X:{type:N,defaultValue:0},Y:{type:N,defaultValue:0},Z:{type:N,defaultValue:0}}},
        "---",
        {opcode:"useCamera", blockType:BlockType.COMMAND, text:"將物件 [NAME] 設為視角攝影機", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"setColor", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 顏色為 [COLOR]", arguments:{NAME:{type:S,defaultValue:"box"},COLOR:{type:C,defaultValue:"#ffffff"}}},
        {opcode:"setOpacity", blockType:BlockType.COMMAND, text:"將物件 [NAME] 的透明度設為 [VALUE] %", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:0}}},
        {opcode:"setPassThrough", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的可穿透狀態為 [STATE]", arguments:{NAME:{type:S,defaultValue:"box"},STATE:{type:S,menu:"onoff"}}},
        {opcode:"setPhysics", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的物理為 [STATE]", arguments:{NAME:{type:S,defaultValue:"box"},STATE:{type:S,menu:"onoff"}}},
        {opcode:"bounce", blockType:BlockType.COMMAND, text:"若物件 [NAME] 與其他物件接觸則彈開", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"isTouching", blockType:BlockType.BOOLEAN, text:"物件 [NAME] 是否接觸物件 [TARGET]", arguments:{NAME:{type:S,defaultValue:"box"},TARGET:{type:S,defaultValue:"target"}}},
        "---",
        {opcode:"start", blockType:BlockType.COMMAND, text:"開始渲染"},
        {opcode:"stop", blockType:BlockType.COMMAND, text:"停止渲染"},
        {opcode:"isDrawing", blockType:BlockType.BOOLEAN, text:"正在渲染嗎？"},
        {opcode:"setFogDistance", blockType:BlockType.COMMAND, text:"設定霧的距離為 [VALUE]", arguments:{VALUE:{type:N,defaultValue:100}}},
        {opcode:"setFogColor", blockType:BlockType.COMMAND, text:"設定霧的顏色為 [COLOR]", arguments:{COLOR:{type:C,defaultValue:"#ffffff"}}},
        {opcode:"setFog", blockType:BlockType.COMMAND, text:"設定霧為 [STATE]", arguments:{STATE:{type:S,menu:"onoff"}}},
        "---",
        {opcode:"setLight", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 為光源 [STATE]", arguments:{NAME:{type:S,defaultValue:"light"},STATE:{type:S,menu:"onoff"}}},
        {opcode:"setLightIntensity", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的光強度為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"light"},VALUE:{type:N,defaultValue:10}}},
        {opcode:"setLightColor", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的光顏色為 [COLOR]", arguments:{NAME:{type:S,defaultValue:"light"},COLOR:{type:C,defaultValue:"#ffffff"}}},
        {opcode:"setReflectivity", blockType:BlockType.COMMAND, text:"設定物件 [NAME] 的反射強度為 [VALUE]", arguments:{NAME:{type:S,defaultValue:"box"},VALUE:{type:N,defaultValue:1}}},
        {opcode:"setRTXShadows", blockType:BlockType.COMMAND, text:"設定 RTX 陰影為 [STATE]", arguments:{STATE:{type:S,menu:"onoff"}}},
        "---",
        {opcode:"getPositionX", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 x 座標", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getPositionY", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 y 座標", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getPositionZ", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 z 座標", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getRotationX", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 x 旋轉（度）", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getRotationY", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 y 旋轉（度）", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getRotationZ", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 z 旋轉（度）", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getScaleX", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 x 縮放（%）", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getScaleY", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 y 縮放（%）", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"getScaleZ", blockType:BlockType.REPORTER, text:"物件 [NAME] 的 z 縮放（%）", arguments:{NAME:{type:S,defaultValue:"box"}}},
        {opcode:"distance", blockType:BlockType.REPORTER, text:"物件 [NAME] 到物件 [TARGET] 的距離", arguments:{NAME:{type:S,defaultValue:"box"},TARGET:{type:S,defaultValue:"target"}}}
